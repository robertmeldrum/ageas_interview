...
The 'ageas_interview' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/ageas_interview/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] ageas_interview_etl` to your workspace.
